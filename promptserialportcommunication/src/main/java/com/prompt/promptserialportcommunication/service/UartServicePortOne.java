...
import static com.prompt.promptserialportcommunication.PromptUtils.mReceivedDataPortOne;
 ...
 */
public class UartServicePortOne extends Service {
    ...
    private void broadcastMessage(String value) {
        ...
        mReceivedDataPortOne.setValue(value);
    }
    ...
    void setConfig(int baud, byte dataBits, byte stopBits, byte parity, byte flowControl) {
        ...
        DLog.e("Config Data Port 1 : ", uartSettings);
    ...
    public static void sendData(int numBytes, byte[] buffer) {
        if (ftDev != null) {
            ...
            PromptUtils.showErrorToast("Port 1 not Open", Toast.LENGTH_LONG);
        }
    }
