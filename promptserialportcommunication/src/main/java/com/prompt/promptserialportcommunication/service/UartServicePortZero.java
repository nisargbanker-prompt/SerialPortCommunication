...
import static com.prompt.promptserialportcommunication.PromptUtils.mReceivedDataPortZero;
 ...
 */
public class UartServicePortZero extends Service {
    ...
    class ReadThread extends Thread {
        ...
        public void run() {
            ...
            while (true == bReadTheadEnable) {
                ...
                DLog.e(TT, "onReceiveiTotalBytes:" + iTotalBytes);
    ...
    private void broadcastMessage(String value) {
        ...
        DLog.e("broadcastMessage: ", value);

        mReceivedDataPortZero.setValue(value);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case UPDATE_TEXT_VIEW_CONTENT:
                    ...
                    //Log.e("Handler", String.copyValueOf(readBufferToChar, 0, actualNumBytes));

                    DLog.e("onReceivereadBufferToChar = ", readBufferToChar + "");
                    DLog.e("onReceiveactualNumBytes = ", actualNumBytes + "");
    ...
    void setConfig(int baud, byte dataBits, byte stopBits, byte parity, byte flowControl) {
        ...
        DLog.e("Config Data Port 0 : ", uartSettings);
