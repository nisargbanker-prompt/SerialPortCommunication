...
import static com.prompt.promptserialportcommunication.PromptUtils.mReceivedDataPortThree;
 ...
 */
public class UartServicePortThree extends Service {
    ...
    private void broadcastMessage(String value) {
        ...
        intent.putExtra("port" , 3);
        LocalBroadcastManager.getInstance(this).sendBroadcast(intent);*/

        mReceivedDataPortThree.setValue(value);
    }
    ...
    void setConfig(int baud, byte dataBits, byte stopBits, byte parity, byte flowControl) {
        ...
        DLog.e("Config Data Port 3 : ", uartSettings);
